...
import ro.ucv.ids.smarthotel.activities.MainActivity;
import android.os.AsyncTask;
import android.util.Log;

public class GetRoomsTaskMain extends AsyncTask<String, String, String> implements URLS {
	
	private WeakReference<MainActivity> activity;
	
	public GetRoomsTaskMain (MainActivity act) {
		super();
